# DevMentor Brasil - Buscador Github
...
Seu desafio é construir este aplicativo Buscador Github usando a [API GITHUB](https://docs.github.com/en/rest/guides/getting-started-with-the-rest-api) e fazer com que pareça o mais próximo possível do design que nós fornecemos.
...
- Acessar a pagina inicial, onde deve ter um campo de texto para o usuário digitar o nome do usuário que deseja buscar do github.
- Ao clicar em buscar deve consultar API do Github e devolver na tela as informações encontradas do usuário conforme o design fornecido.
...
No site você baixou os arquivos iniciais para começar o projeto com HTML, CSS e JavaScript mas você tambem pode usar qualquer framework ou biblioteca caso deseje como ReactJS, Angular, Vuejs sem nenhum problema.
